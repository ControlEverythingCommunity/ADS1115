...
print "Digital Value of Analog Input on AIN0 & AIN1: %d" %raw_adc

# ADS1115 address, 0x48(72)
# Select configuration register, 0x01(01)
#		0x9483(38019)	AINP = AIN0 and AINN = AIN3, +/- 2.048V
#						Continuous conversion mode, 128SPS
data = [0x94,0x83]
bus.write_i2c_block_data(0x48, 0x01, data)
...
# Output data to screen
print "Digital Value of Analog Input on AIN0 & AIN3: %d" %raw_adc

# ADS1115 address, 0x48(72)
# Select configuration register, 0x01(01)
#		0xA483(42115)	AINP = AIN1 and AINN = AIN3, +/- 2.048V
#						Continuous conversion mode, 128SPS
data = [0xA4,0x83]
bus.write_i2c_block_data(0x48, 0x01, data)
...
# Output data to screen
print "Digital Value of Analog Input on AIN1 & AIN3: %d" %raw_adc

# ADS1115 address, 0x48(72)
# Select configuration register, 0x01(01)
#		0xB483(46211)	AINP = AIN2 and AINN = AIN3, +/- 2.048V
#						Continuous conversion mode, 128SPS
data = [0xB4,0x83]
bus.write_i2c_block_data(0x48, 0x01, data)
...
# Output data to screen
print "Digital Value of Analog Input on AIN2 & AIN3: %d" %raw_adc
